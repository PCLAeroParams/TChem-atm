...
#include "Tines_Interface.hpp"
    ...
    static int ProblemAtmosphericChemistryE3SM_ComputeFunctionCVODE(sunrealtype t,
               N_Vector u,
               N_Vector f,
               void *user_data) {
      using host_device_type = Tines::UseThisDevice<Kokkos::Serial>::type;
      using problem_type = AtmosphericChemistryE3SM_Problem<sunrealtype,host_device_type>;
    ...
    static int ProblemAtmosphericChemistryE3SM_ComputeJacobianCVODE(sunrealtype t,
               N_Vector u,
               N_Vector f,
               SUNMatrix J,
               void *user_data,
