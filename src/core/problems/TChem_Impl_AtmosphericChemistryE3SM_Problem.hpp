...
=====================================================================================
*/
#ifndef __TCHEM_ATMOSPHERIC_CHEMISTRY_E3SM_PROBLEM_HPP__
#define __TCHEM_ATMOSPHERIC_CHEMISTRY_E3SM_PROBLEM_HPP__
...
namespace Impl {
  ...
  struct AtmosphericChemistryE3SM_Problem
  {
    ...
    real_type_1d_view_type _external_sources;
    real_type_1d_view_type _const_concentration;
    real_type_1d_view_type _photo_rates;
    kinetic_model_type _kmcd;
    real_type _temperature;
    real_type _pressure;

    KOKKOS_DEFAULTED_FUNCTION
    AtmosphericChemistryE3SM_Problem() = default;
    ...
    static ordinal_type getWorkSpaceSize(const kinetic_model_type& kmcd)
    {
      ...
      = NetProductionRates<value_type, device_type>::getWorkSpaceSize(kmcd);
                                                ...
                                                const real_type_1d_view_type& f) const
    {
      ...
      if (_kmcd.nConstSpec > 0 ) {
        ...
        ::team_invoke(member, _temperature, _pressure, x,_photo_rates, _external_sources, _const_concentration, f, _work,  _kmcd);

      } else {
        Impl::NetProductionRates<real_type, device_type>
        ::team_invoke(member, _temperature, _pressure, x,_photo_rates,_external_sources, f, _work,  _kmcd);
      }
    ...
    if (_kmcd.nConstSpec > 0 ) {
      ...
      Impl::NetProductionRates<value_type, device_type>
          ::team_invoke_sacado(member, _temperature, _pressure, x,_photo_rates,_external_sources, f, _work,  _kmcd);
    }
