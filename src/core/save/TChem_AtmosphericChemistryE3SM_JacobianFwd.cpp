...
===================================================================================== */
#include "TChem_AtmosphericChemistryE3SM_JacobianFwd.hpp"
...
namespace TChem {
  ...
  template<typename PolicyType,
           typename DeviceType>
  void
  AtmosphericChemistryE3SM_JacobianFwd_TemplateRun( /// required template arguments
                                          ...
                                          const KineticModelConstData<DeviceType >& kmcd)
  {
    ...
    const ordinal_type per_team_extent = TChem::AtmosphericChemistryE3SM_JacobianFwd::getWorkSpaceSize(kmcd);
       ...
       KOKKOS_LAMBDA(const typename policy_type::member_type& member) {
        ...
        for (ordinal_type i=ibeg;i<iend;i+=iinc) {
          ...
          TCHEM_CHECK_ERROR(!sv_at_i.isValid(), "Error: input state vector is not valid");
          {
            ...
            {
               using problem_type =
      TChem::Impl::AtmosphericChemistryE3SM_Problem<real_type, device_type>;
    ...
    member.team_barrier();
            ...
            Impl::AtmosphericChemistryE3SM_JacobianFwd<real_type, device_type>::team_invoke(member,
                                                                                   vals,
                                                                                   jacobian_at_i,
                                                                                   fac_at_i, // output
                                                                                   pressure,
  ...
  void
  AtmosphericChemistryE3SM_JacobianFwd::runDeviceBatch( /// thread block size
  ...
  {
    AtmosphericChemistryE3SM_JacobianFwd_TemplateRun( /// template arguments deduction
                                            "TChem::AtmosphericChemistryE3SM_JacobianFwd::runDeviceBatch",
                                            policy,
                                            state,
                                            jacobian,
                                            fac,
  ...
  void
  AtmosphericChemistryE3SM_JacobianFwd::runHostBatch( /// thread block size
  ...
  {
    AtmosphericChemistryE3SM_JacobianFwd_TemplateRun( /// template arguments deduction
                                            "TChem::AtmosphericChemistryE3SM_JacobianFwd::runHostBatch",
                                            policy,
                                            state,
                                            jacobian,
                                            fac,
