...
===================================================================================== */
#ifndef __TCHEM_ATMOSPHERIC_CHEMISTRY_E3SM_JACOBIAN_FWD_HPP__
#define __TCHEM_ATMOSPHERIC_CHEMISTRY_E3SM_JACOBIAN_FWD_HPP__
...
struct AtmosphericChemistryE3SM_JacobianFwd
{
  ...
  {
    return Impl::AtmosphericChemistryE3SM_JacobianFwd<real_type,DeviceType>::getWorkSpaceSize(kmcd) + (kmcd.nSpec + 1);
  }
