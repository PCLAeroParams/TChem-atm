...
===================================================================================== */
#ifndef __TCHEM_NET_PRODUCTION_RATES_HPP__
#define __TCHEM_NET_PRODUCTION_RATES_HPP__
...
struct NetProductionRates
{
  ...
  {
    return Impl::NetProductionRates<real_type,DeviceType>::getWorkSpaceSize(kmcd);
  }
