...
namespace TChem {
  ...
  template<typename PolicyType,
           typename DeviceType>
void
ReactionRates_TemplateRun( /// input
  ...
  /// output
  const Tines::value_type_2d_view<real_type, DeviceType>& kfwd,
  ...
  const KineticModelNCAR_ConstData<DeviceType >& kmcd)
{
  ...
  TChem::ReactionRates::getWorkSpaceSize(kmcd);
  ...
  Kokkos::parallel_for(
    ...
    KOKKOS_LAMBDA(const typename policy_type::member_type& member) {
      ...
      const real_type_1d_view_type kfwd_at_i =
        Kokkos::subview(kfwd, i, Kokkos::ALL());
                        ...
                        "Error: input state vector is not valid");
      {
        ...
        Impl::ReactionRates<real_type, device_type>
        ::team_invoke(member, t, p, Ys, kfwd_at_i, kmcd);
...
void
ReactionRates::runHostBatch( /// input
  ...
  const kinetic_model_host_type& kmcd)
{
  ...
  ReactionRates_TemplateRun( /// input
    "TChem::ReactionRates::runHostBatch",
    policy,
    state,
    kfwd,
    kmcd);
...
void
ReactionRates::runDeviceBatch( /// input
  ...
  const kinetic_model_type& kmcd)
{
  ...
  ReactionRates_TemplateRun( /// input
    "TChem::ReactionRates::runDeviceBatch",
    policy,
    state,
    kfwd,
    kmcd);
...
ReactionRates::runDeviceBatch( /// input
  ...
  const kinetic_model_type& kmcd)
{
  Kokkos::Profiling::pushRegion("TChem::ReactionRates::runDeviceBatch");
